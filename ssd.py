...
class SSD(object):
    _defaults = {
        "model_path": r'C:\Users\520\Desktop\2\logs\28_14_1_Epoch39_Loc1.8497-Conf0.0000.pth',
        # "model_path": 'F:/SSD_project/ustc_ssd/ssd-pytorch-master/model_data/ssd_weights.pth',
        "classes_path": './cfg.txt',
    ...
    def generate(self):
        ...
        model = ssd.get_ssd("test", self.num_classes,300)
    ...
    def detect_image(self, image):
        ...
        # crop_img = np.array(letterbox_image(image), dtype=np.float64)
        crop_img = np.array(letterbox_image(image))
        ...
        for i in range(preds.size(1)):
            ...
            while preds[0, i, j, 0] >= self.confidence:
                score = preds[0, i, j, 0]
                label_name = '1'  # self.class_names[i - 1]''
